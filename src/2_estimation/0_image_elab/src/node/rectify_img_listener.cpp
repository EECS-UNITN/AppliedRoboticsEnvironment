...
int main(int argc, char **argv) {
  ros::init(argc, argv, "rectify_image_listener");
  ros::NodeHandle nodeHandle("~");

  std::string default_implementation_field = "/default_implementation/rectify_clbk";
  std::string camera_subscriber_topic_name = "/image/rectify";  
